      ...
      <el-col :span="12">
        <el-form ref="form" :rules="rules" :model="form" label-width="120px">
          ...
          <el-form-item label="*活动方式">
            <el-select v-model="value" clearable  :placeholder="actType">
              <el-option
...
<script>
import { activityDetail, actEdit, getClubList } from "@/api/api";
...
export default {
  ...
  methods: {
    ...
    changeSchoolArr() {
      ...
      if (reg.test(this.form_cms_school_name)) {
        getClubList(this.form_cms_school_name, "", "", "", "", "", 100).then(
          res => {
  ...
  mounted() {
    ...
    activityDetail(this.act_id).then(res => {
      ...
      this.form_cms_school_name = res.data.org_name;
      this.value = res.data.line_type;
      this.value2 = res.data.activity_start_at
      this.actType = res.data.line_type;
    });
  }
};
</script>
