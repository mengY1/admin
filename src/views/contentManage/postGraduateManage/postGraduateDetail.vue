<template>
  <div class="wrapper">
    ...
    <el-row style="margin-top:30px;border-bottom:none;">
      <el-col :span="2">
        <el-button type="primary" size="medium" v-if="info.line_status==0" @click="up" plain>上架</el-button>
      </el-col>
      <el-col :span="2">
        <el-button type="primary" size="medium" v-if="info.line_status==1" @click="low" plain>下架</el-button>
      </el-col>
      <el-col :span="2">
...
import { activityDetail, actPut, actDelete,getApplyList } from "@/api/api";
export default {
  components: {},
  props: {},
  data() {
