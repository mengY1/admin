<template>
  <div class="banner">
    <el-row style="margin-top:10px">
      ...
      <el-col :span="2" style="margin-right:10px">
        <el-button type="primary" @click="releaseDaily">发布爆料</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <span @click="getDetail(scope.row.news_id)">
                <el-button size="small" @click="dialogTableVisible = true">预览</el-button>
              </span>
              <el-dialog width="375px" title="爆料预览" :visible.sync="dialogTableVisible">
                <div class="content">
                  ...
                  <div class="video" v-if="detailInfo.video_url">
                    <video :src="detailInfo.video_url" controls="controls" width="335px" height="188px"></video>
                  </div>
                  <div class="text">
              ...
              <el-button size="small" @click="toDetail(scope.row.news_id)">详情</el-button>
              <el-button
                size="small"
                @click="toEdit(scope.row.news_id)"
                v-if="scope.row.line_status==0&&!lineIdentity"
              >编辑</el-button>
              <el-button size="small" @click="toEdit(scope.row.news_id)" v-if="lineIdentity">编辑</el-button>
              ...
              <el-button
                ...
                :plain="true"
                v-if="scope.row.line_status==0&&lineIdentity"
                @click="upAndLow(scope.row.news_id)"
              >上架</el-button>
              <el-button
                size="small"
                :plain="true"
              ...
              <el-button
                ...
                @click="dailyStick(scope.row.news_id)"
              >置顶</el-button>
...
export default {
  ...
  methods: {
    getDetail(news_id) {
      this.detailInfo=""
      getDailyDetail(news_id).then(res => {
        this.detailInfo = res.data;
      });
    },
    // 上下架
    upAndLow(news_id) {
      dailyUpAndLow(news_id).then(res => {
        this.$message({
          message: "操作成功",
          type: "success"
        });
