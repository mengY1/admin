<template>
  <div class="wrapper">
    ...
    <el-button type="primary" :plain="true" @click="addPlan">发布</el-button>
  </div>
</template>

<script>
import { addPlan, getPlanTypeList, updateDraft } from "@/api/api";
  ...
  methods: {
    ...
    addPlan() {
      ...
      addPlan({
        ...
        scheme_content: this.dat.content,
        publish_at: this.value1,
        top_status: this.top_status,
        video_url: this.url1,
        scheme_poster_caption: this.dat2.content,
